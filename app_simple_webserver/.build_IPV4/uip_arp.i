...
# 379 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_arp.c"
  if(uip_ipaddr_cmp(((struct ethip_hdr *)&uip_buf[0])->destipaddr, broadcast_ipaddr)) {
    ...
    if(!(((((u16_t *)((struct ethip_hdr *)&uip_buf[0])->destipaddr)[0] & ((u16_t *)uip_netmask)[0]) == (((u16_t *)uip_hostaddr)[0] & ((u16_t *)uip_netmask)[0])) && ((((u16_t *)((struct ethip_hdr *)&uip_buf[0])->destipaddr)[1] & ((u16_t *)uip_netmask)[1]) == (((u16_t *)uip_hostaddr)[1] & ((u16_t *)uip_netmask)[1])))) {
      ...
      uip_ipaddr_copy(ipaddr, ((struct ethip_hdr *)&uip_buf[0])->destipaddr);
    }
 ...
 break;
    ...
    if(i == 8) {
      ...
      uip_ipaddr_copy(((struct arp_hdr *)&uip_buf[0])->dipaddr, ipaddr);
      uip_ipaddr_copy(((struct arp_hdr *)&uip_buf[0])->sipaddr, uip_hostaddr);

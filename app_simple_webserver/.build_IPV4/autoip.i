# 1 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/autoip/autoip.c"
...
# 7 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/autoip/autoip.c" 2
...
# 8 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/autoip/autoip.c" 2
...
# 9 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/autoip/autoip.c" 2
# 1 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/timer.h" 1
# 10 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/autoip/autoip.c" 2
# 1 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/clock-arch.h" 1
# 11 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/autoip/autoip.c" 2
...
# 12 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/autoip/autoip.c" 2
...
# 13 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/autoip/autoip.c" 2
...
static struct arp_hdr autoip_arp_pkt = {
  { { { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff } },
    { { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
      (u16_t)((((u16_t) (0x0806)) << 8) | (((u16_t) (0x0806)) >> 8)) },
  (u16_t)((((u16_t) (1)) << 8) | (((u16_t) (1)) >> 8)),
  (u16_t)((((u16_t) (0x0800)) << 8) | (((u16_t) (0x0800)) >> 8)),
  6,
  4,
  (u16_t)((((u16_t) (1)) << 8) | (((u16_t) (1)) >> 8)),
  { { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
...
# 60 "/home/vdelacruz/Documents/Ethernet sin mii/module_xtcp/src/xtcp_uip/autoip/autoip.c"
...
{
 memcpy(((struct arp_hdr *)&uip_buf[0]), &autoip_arp_pkt, sizeof(autoip_arp_pkt));
...
{
  create_arp_packet();
  uip_ipaddr_copy(((struct arp_hdr *)&uip_buf[0])->dipaddr, autoip_state->ipaddr);
...
static void send_announce()
{
  create_arp_packet();
  uip_ipaddr_copy(((struct arp_hdr *)&uip_buf[0])->dipaddr, autoip_state->ipaddr);
  uip_ipaddr_copy(((struct arp_hdr *)&uip_buf[0])->sipaddr, autoip_state->ipaddr);
  ...
  switch (autoip_state->state)
    {
      ...
      case PROBING:
      case WAIT_FOR_ANNOUNCE:
        if (uip_ipaddr_cmp(((struct arp_hdr *)&uip_buf[0])->sipaddr, autoip_state->ipaddr)) {

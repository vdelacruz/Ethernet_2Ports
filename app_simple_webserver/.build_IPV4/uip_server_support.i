# 1 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c"
...
# 7 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c" 2
...
# 8 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c" 2
...
# 9 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c" 2
...
# 11 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c" 2
...
# 12 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c" 2
# 1 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip-split.h" 1
# 97 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip-split.h"
void uip_split_output(chanend mac_tx);
# 13 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c" 2
...
# 14 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c" 2
...
# 15 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c" 2


unsigned int uip_buf32[(((1472) + 14 + (20 + 20)) + 5) >> 2];
u8_t *uip_buf = (u8_t *) &uip_buf32[0];
# 43 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c"
int uip_static_ip = 0;
...
void uip_server_init(chanend xtcp[], int num_xtcp, xtcp_ipconfig_t* ipconfig, unsigned char mac_address[6])
{
 ...
 if (ipconfig != 0 && (*((int*)ipconfig->ipaddr) != 0)) {
  uip_static_ip = 1;
 }
 ...
 if (ipconfig == 0)
 {
  ...
  uip_ipaddr_copy(uip_hostaddr, (ipconfig->ipaddr));
  uip_ipaddr_copy(uip_draddr, (ipconfig->gateway));
  uip_ipaddr_copy(uip_netmask, (ipconfig->netmask));
...
void xtcp_process_incoming_packet(chanend mac_tx, int length)
{
 if (((struct uip_eth_hdr *)&uip_buf[0])->type == htons(0x0800)) {
  ...
  if (uip_len > 0) {
   if ((uip_conn == 0)
    && (((struct uip_tcpip_hdr *)&uip_buf[14])->proto != 1)
...
void autoip_configured(uip_ipaddr_t autoip_ipaddr) {
 if (!dhcp_done) {
  ...
  uip_ipaddr_copy(uip_hostaddr, (autoip_ipaddr));
...
void uip_linkup() {
 ...
 if (uip_static_ip) {
# 274 "/home/vdelacruz/Documents/Ethernet 2 Ports/module_xtcp/src/xtcp_uip/uip_server_support.c"
  uip_ipaddr_copy(uip_hostaddr, (uip_static_ipconfig.ipaddr));
  uip_ipaddr_copy(uip_draddr, (uip_static_ipconfig.gateway));
  uip_ipaddr_copy(uip_netmask, (uip_static_ipconfig.netmask));
